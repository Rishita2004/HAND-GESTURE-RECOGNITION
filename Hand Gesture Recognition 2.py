    ...
    if result.multi_hand_landmarks:
        for hand_landmarks in result.multi_hand_landmarks:    
            ...
            for id, landm in enumerate(hand_landmarks.landmark):
                ...
                h, w, _ = frame.shape
                cx, cy = int(hand_landmarks.landmark[my_hands.HandLandmark.INDEX_FINGER_TIP].x * w), int(hand_landmarks.landmark[my_hands.HandLandmark.INDEX_FINGER_TIP].y * h)
                
                print({hand_landmarks.landmark[my_hands.HandLandmark.INDEX_FINGER_TIP].x * w}, 
                     {hand_landmarks.landmark[my_hands.HandLandmark.INDEX_FINGER_TIP].y * h})
                print(cx,cy)
